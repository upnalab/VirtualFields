...
targetAmplitude = 25 * (emittersPerSide*emittersPerSide/16*16)
#derived variables
wavelength = c/fr 
...
opti = ArrayAmpSlice()
mse, amps, phases, field = opti.optimizeAmpSlice(propagators, target, False )
...
cmaps = {}
cmaps['parula'] = ListedColormap(cm_data,name='parula')
parula = cmaps['parula']
plt.imshow(outputAmp, cmap = parula)
plt.colorbar()
